...
public class medium_program_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_program_list);
        ...
        try {
            InputStream is = getAssets().open("info2.xls");
        ...
        try {
            InputStream is = getAssets().open("link2.xls");
            Workbook wb = Workbook.getWorkbook(is);
            Sheet s = wb.getSheet(0);
            int row = s.getRows();
            int col = s.getColumns();
        ...
        ListAdapter listAdapter = new ArrayAdapter<String>(this, R.layout.row2, R.id.row2, progrmaList);
